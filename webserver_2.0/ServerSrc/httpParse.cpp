...
//            std::cout << " -------------------------------HttpConnect.cpp:  handle write func: write error---------"
//                      << std::endl;
            perror("writen");
            error_ = true;
        }
...
//    std::cout << " -------------------------------HttpConnect.cpp analysis request func" << std::endl;
    ...
    if (httpMethod_ == METHOD_POST) {
        ...
        if (fileName_ == "favicon.ico") {
            ...
            hd += "Content-Length: " + std::to_string(sizeof favicon) + "\r\n";
            hd += "Server: LinYa's Web Server\r\n";
...
void HttpConnect::linkTimer(TimerNode *timer) {
    timer_ = timer;
}
